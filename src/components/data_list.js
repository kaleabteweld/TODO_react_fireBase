...
export class Data_list extends Component {
    ...
    render() {
        ...
        if (this.state.edit) {
            return(    
            <div className="todo">
                <input value={this.state.done} onChange={this.cheack} type="checkbox" name="done" id="done"></input>
            ...
            return(    
                <div className="todo">
                    ...
                    <input value={this.state.input} onChange={this.input} className="To_input" type="text" name="TODO" id="TODO"></input> 

                    <div id="edi"> 
                        <img id="cancel" onClick={this.cancel} src="https://img.icons8.com/cute-clipart/50/000000/cancel-2.png"/>
                        <img  id="save" onClick={this.save} src="https://img.icons8.com/fluent/48/000000/checkmark.png"/>
                    </div>
            </div>);
        }
    }
